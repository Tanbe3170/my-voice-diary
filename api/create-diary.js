...
function buildNormalPrompt(rawText, today, styleInstruction, styleId) {
...
【出力形式】
${JSON_OUTPUT_SCHEMA(today, styleId)}
...
function buildDinoStoryPrompt(rawText, today, dinoContext, styleInstruction, styleId) {
...
function buildDinoResearchPrompt(rawText, today, dinoContext, styleInstruction, styleId) {
...
export function buildPrompt(mode, rawText, today, dinoContext, styleInstruction, styleId) {
  switch (mode) {
    case 'dino-story':
      return buildDinoStoryPrompt(rawText, today, dinoContext, styleInstruction, styleId);
    case 'dino-research':
      return buildDinoResearchPrompt(rawText, today, dinoContext, styleInstruction, styleId);
    default:
      return buildNormalPrompt(rawText, today, styleInstruction, styleId);
  }
}
...
export default async function handler(req, res) {
  ...
  try {
    ...
    let claudePrompt = buildPrompt(effectiveMode, rawText, today, effectiveMode.startsWith('dino-') ? dinoContext : null, styleInstruction, styleId);
